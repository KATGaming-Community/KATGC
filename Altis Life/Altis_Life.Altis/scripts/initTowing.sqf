...
SA_Add_Player_Tow_Actions = {
    ...
    }, nil, 0, false, true, "", "call SA_Take_Tow_Ropes_Action_Check && playerSide isEqualTo independent"];
 
    player addAction ["Put Away Tow Ropes", {
        [] call SA_Put_Away_Tow_Ropes_Action;
    }, nil, 0, false, true, "", "call SA_Put_Away_Tow_Ropes_Action_Check && playerSide isEqualTo independent"];
 
    player addAction ["Attach To Tow Ropes", {
        [] call SA_Attach_Tow_Ropes_Action;
    }, nil, 0, false, true, "", "call SA_Attach_Tow_Ropes_Action_Check && playerSide isEqualTo independent"];
 
    player addAction ["Drop Tow Ropes", {
        [] call SA_Drop_Tow_Ropes_Action;
    }, nil, 0, false, true, "", "call SA_Drop_Tow_Ropes_Action_Check && playerSide isEqualTo independent"];
 
    player addAction ["Pickup Tow Ropes", {
        [] call SA_Pickup_Tow_Ropes_Action;
    }, nil, 0, false, true, "", "call SA_Pickup_Tow_Ropes_Action_Check && playerSide isEqualTo independent"];
