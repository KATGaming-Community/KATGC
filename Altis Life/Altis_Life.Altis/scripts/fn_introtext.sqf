...
_role1names = ["Framework By Tonic"];
_role2 = "Modified By";
_role2names = ["Larry Lancelot, Its Jordan, Fresqo"];
_role3 = "Visit Our Forums at";
_role3names = ["GiG.invisionzone.com"];
...
_finalText = format ["<t size='0.55' color='#0962f2' align='right'>%1<br /></t>", _memberFunction];
