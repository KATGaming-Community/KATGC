...
/* Database Related Settings */
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","zipties","blindfold","handcuffs","keys","goldbar","blastingcharge","boltcutter","pesticide","oil_unprocessed","oil_unprocessed","copper_unrefined","copper_refined","iron_unrefined","iron_refined","salt_refined","salt_refined","sand","glass","diamond_uncut","diamond_cut","rock","cement","heroin_unprocessed","heroin_processed","cannabis","marijuana","cocaine_unprocessed","cocaine_processed","turtle_raw", "storagesmall", "storagebig","furnituredesk", "furniturechair", "furniturebagshort", "furnitureopenlaptop", "furniturecampingtable", "furnituresleepingbag", "furnituresleepingbagblue", "furnituresleepingbagbrown", "furnituresunchair", "furnituresunchairgreen", "furnituretenta", "furnituremapaltis", "furniturepalletvert", "furnituremetalrack", "furniturewoodblue", "furniturefmradio", "furnitureportgen", "furnituretarget", "furniturewoodtable", "kidney","chainsaw","logs","planks"  };
...
/* System Settings */
    ...
    jailBreak_cops = 5; //Minimum cops for jail breal.
    ...
    fuel_cost = 102; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    ...
    jail_seize_vItems[] = { "spikeStrip","lockpick","goldbar","blastingcharge","boltcutter","defusekit","heroin_unprocessed","heroin_processed","cannabis","marijuana","cocaine_unprocessed","cocaine_processed","turtle_raw","zipties","blindfold","kidney" }; //Define VIRTUAL items you want to be removed from players upon jailing here. Use "jail_seize_inventory" for Arma inventory items.
    ...
    vehicle_storage_fee_multiplier = .004; //Pull from garage cost --> Cost takes the playersides Buy Price * multiplier
    ...
    crimes[] = {
        ...
        {"STR_Crime_8","1200","8"},
        {"STR_Crime_9","8000","9"},
        {"STR_Crime_10","5000","10"},
        {"STR_Crime_11","15000","11"},
        {"STR_Crime_12","30000","12"},
        ...
        {"STR_Crime_19","200000","19"},
        {"STR_Crime_481","5000","481"},
        {"STR_Crime_481P","10000","481P"},
        {"STR_Crime_20","15000","20"},
        {"STR_Crime_483","20000","483"},
        {"STR_Crime_21","30000","21"},
        {"STR_Crime_22","5000","22"},
        {"STR_Crime_211","36000","211"},
        {"STR_Crime_23","30000","23"},
        {"STR_Crime_24","50000","24"},
        {"STR_Crime_25","200000","25"},
        {"STR_Crime_26","10000","26"},
        {"STR_Crime_27","20000","27"},
        {"STR_Crime_28","30000","28"},
        {"STR_Crime_29","50000","29"},
        {"STR_Crime_482","30000","482"},
        {"STR_Crime_30","80000","30"},
        {"STR_Crime_31","3000","31"},
        ...
        {"STR_Crime_36","50000","36"},
        {"STR_Crime_37","5000","37"},
        {"STR_Crime_38","50000","58"},
        {"STR_Crime_487","15000","487"},
        {"STR_Crime_459","20000","459"},
        {"STR_Crime_215","10000","215"},
        {"STR_Crime_901","20000","901"},
        {"STR_Crime_39","20000","39"},
        {"STR_Crime_40","40000","40"},
        {"STR_Crime_41","30000","41"},
        {"STR_Crime_42","75000","42"},
        {"STR_Crime_43","90000","43"},
