...
class Clothing {
    ...
    class cop {
        ...
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_police", "", 25, { "", "", -1 } },
            { "H_HelmetB_plain_mcamo", "", 75, { "life_gigcoplevel25", "SCALAR", 1 } },
            { "H_MilCap_mcamo", "", 100, { "life_gigcoplevel25", "SCALAR", 2 } },
    ...
    class reb {
        ...
        vests[] = {
            ...
            { "V_PlateCarrierIA1_dgtl", "",20000, {"", "", -1} },
            { "V_PlateCarrierIAGL_dgtl", "", 25000, {"", "", -1 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } },
            { "B_OutdoorPack_blk", "", 500, { "", "", -1 } },
