...

{
    ...
    detach _var;
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-3.06745,15.3228,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-15.8078,2.58262,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-15.8074,15.3228,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-3.06745,28.0628,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-28.5474,2.58262,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-15.8074,28.0628,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-28.5474,15.3228,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-28.5474,28.0628,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-3.06745,40.8028,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-41.2874,2.58262,-8.6]];
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [9.67255,40.8028,-8.6]];
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-41.2878,-10.1612,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-15.8074,40.8028,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-41.2874,15.3228,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-28.5474,40.8028,-8.6]]; 
    detach _var; 
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-41.2874,28.0628,-8.6]]; 
    detach _var;
    _var = createVehicle ["Land_Canal_Dutch_01_plate_F", [0,1,0], [], 0, "NONE"]; 
    _var attachTo [_hs, [-41.2874,40.8028,-8.6]]; 
    detach _var;
