...
//-------------------- 2. SPAWN OBJECTIVES
	...
	priorityObj1 = "O_T_APC_Tracked_02_AA_ghex_F" createVehicle _flatPos1;
	waitUntil {!isNull priorityObj1};
	priorityObj1 setDir _PTdir;
	
	sleep 1;
	
	priorityObj2 = "O_T_APC_Tracked_02_AA_ghex_F" createVehicle _flatPos2;
	...
	ammoTruck = "O_T_Truck_03_ammo_ghex_F" createVehicle _flatPos3;
...
//-------------------- 3. SPAWN CREW
	...
	_priorityGroup = createGroup east;
		...
		"O_T_Officer_F" createUnit [_flatPos, _priorityGroup];
		"O_T_Officer_F" createUnit [_flatPos, _priorityGroup];
		"O_T_Engineer_F" createUnit [_flatPos, _priorityGroup];
		"O_T_Engineer_F" createUnit [_flatPos, _priorityGroup];
