...
//------------------------------------------- SPAWN OBJECTIVE AND AMBIENCE 
	...
	assaultBoat = "O_T_Boat_Transport_01_F" createVehicle _assaultBoatPos;
...
//-------------------- BRIEFING
	...
	["NewSideMission", "Secure Smuggled Explosives"] remoteExec ["AW_fnc_globalNotification",0,false];
	sideMarkerText = "Secure Smuggled Explosives";
