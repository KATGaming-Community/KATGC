...
_targets = ["Balavu","Rautake","Tavu","Dr_Steve_Zissou_Center_For_Aquatic_Excellence","Namuvaka","Bala_Airstrip","Yanukka","KatKoula","Lailai","Imuri_Island","Bacons_Mound","Sheeps_Hump","Lakatoro"];
