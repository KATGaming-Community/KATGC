...
/* milcrate DELETE WEAPS */
clearWeaponCargoGlobal milcrate;
clearMagazineCargoGlobal milcrate;
clearItemCargoGlobal milcrate;
...
aiSpawn = ["hunting_zone",100] spawn TON_fnc_huntingZone;
...
[] spawn "\life_server\Functions\Events\fn_airdrop.sqf"
