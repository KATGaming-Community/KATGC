...
*/
waitUntil {life_admin_playerMarkers || life_admin_vehicleMarkers || !visibleMap};
...
while {(_this select 0)} do 
{
	...
	if (!(_adminPlayerMarkerStatus isEqualTo life_admin_playerMarkers) || !(_adminVehicleMarkerStatus isEqualTo life_admin_vehicleMarkers)) then 
	{
