...
private _admin = [_this,4,"",[""]] call BIS_FNC_PARAM;
...
if (CASH < _price && _admin isEqualTo "") exitWith {hint format [localize "STR_NOTF_NE_1",[_price] call life_fnc_numberText,localize _displayName];};
